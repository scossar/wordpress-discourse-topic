jQuery(document).ready(function($) {
  ...
  // As a temporary fix for the way WordPress saves categories, the #category-adder div
  // has been hidden. Categories may only be added on the 'Add New Category' page.
  // Todo: add ajax method to save categoryies as they are added with the 'new category'
